...
(<button onClick={like}><img className='heart' src='http://i.imgur.com/6XPFTeT.png'/></button>)

const unlikeButton = (unlike) =>
(<button onClick={unlike}><img className='heart' src='http://imgur.com/CKSBKf5.png'/></button>)
